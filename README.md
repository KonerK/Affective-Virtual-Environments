...
The use of virtual reality (VR) for mood induction is well-documented. We know we can use a variety of different virtual environments (VEs) to evoke different emotions, but understanding how we can manipulate one virtual environment to induce different emotions is underexplored. Such investigation is important to minimize the effects of confounding variables in emotion studies that make use of VR. This work, then, focuses on the creation of four affective environments designed to induce a specific emotion through as minimal changes as possible (colour, sound design, environmental objects) to allow for better use of affective VR in HCI research. 

This project discusses work carried out in my dissertation. The Unity assets used for development during this project can be found [here][1]. This research was undertaken in collaboration with another student from the University of Bath. The development size exceeds 128GB, and the environments themselves are currently held in a private repository owned by the University of Bath, which will be referenced when this repository becomes public. 
